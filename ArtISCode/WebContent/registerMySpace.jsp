...
<p><label for="form1_firstname">Firstname:</label><input type="text" id="form1_firstname" name="firstname" value="<%=firstName%>" size="25" /></p>
...
<p><label for="street">Street:</label><input type="text" name="street"size="60" value="<%=street %>"/> </p>
<p><label for="city">City:</label><input type="text"name="city" size="25" value="<%=city%>"/></p>
