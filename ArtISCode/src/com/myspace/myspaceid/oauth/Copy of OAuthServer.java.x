...
public class OAuthServer {
	...
	/**
	 * Sets the request token to use.
	 * @param requestToken The request token that has been obtained and which we will use against this server.
	 */
...
//	}
	...
	public String generateRequestUrl(String path, Map<String, String> args, String method, Set<String> removeParams) {
		...
		String combinedSecret = consumer.getSecret() + "&" + (accessToken == null ? "" : accessToken.getSecret());
