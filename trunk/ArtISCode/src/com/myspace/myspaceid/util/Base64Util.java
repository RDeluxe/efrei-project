...
/* ********  P U B L I C   F I E L D S  ******** */
    ...
    /**
     * Don't break lines when encoding (violates strict Base64Util specification)
     */
...
/* ********  E N C O D I N G   M E T H O D S  ******** */
     ...
     * <p/>
     * Example: <code>encodeObject( myObj, Base64Util.GZIP | Base64Util.DONT_BREAK_LINES )</code>
     *
     * @param serializableObject The object to encode
     ...
     * <p/>
     * Example: <code>encodeBytes( myData, Base64Util.GZIP | Base64Util.DONT_BREAK_LINES )</code>
     *
     * @param source  The data to convert
     * @param options Specified options
     * @see Base64Util#GZIP
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
            ...
            )
    {
        ...
        for (i = off; i < off + len; i++) {
            ...
            if (sbiDecode >= WHITE_SPACE_ENC) // White space, Equals sign or better
            {
                ...
                System.err.println("Bad Base64Util input character at " + i + ": " + source[i] + "(decimal)");
                return null;
            }   // end else:
    ...
    public static byte[] decodeFromFile(String filename)
    {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64Util.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64Util.DECODE);
    ...
    public static String encodeFromFile(String filename)
    {
        ...
        try {
            ...
            // Open a stream
            bis = new Base64Util.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64Util.ENCODE);
